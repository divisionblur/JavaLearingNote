...
- Spring的配置文件
  ...
  <!--一个constructor-arg标签代表着 构造方法中的一个参数 (顺序要和构造参数一样，个数也要一样)-->
  <!--constructor-arg标签里 对应着赋值-->
  <!--实际开发基本上都是基于注解的方式-->
  ~~~
...
- 细节
  ...
  - isSingleton方法
    ...
    **2. 返回 false 每一次都会创建新的对象**
    ...
    ![image-20201204215002731](https://gitee.com/studylihai/pic-repository/raw/master/%5Cimg/20201204215002.png)
